...
class User(AbstractUser):
    ...
    gender = models.CharField(
        _("gender"), max_length=1, choices=GenderChoises.choices, null=True, blank=True
    )
    level = models.CharField(
        _("level"), max_length=3, choices=LevelChoises.choices, null=True, blank=True
    )
    target = models.CharField(
        _("target"), max_length=2, choices=TargetChoises.choices, null=True, blank=True
    )
